...
func TestMergeSet(t *testing.T) {
	...
	a := Set{
		Standard:   List{"fmt"},
		ThirdParty: List{"github.com/myron-meng/sqlboiler/v4", "github.com/volatiletech/null/v8"},
	}
	b := Set{
		Standard:   List{"os"},
		ThirdParty: List{"github.com/myron-meng/sqlboiler/v4"},
	}
	...
	if c.ThirdParty[0] != "github.com/volatiletech/null/v8" && c.ThirdParty[1] != "github.com/myron-meng/sqlboiler/v4" {
