...
[![GoDoc](https://img.shields.io/badge/godoc-reference-5272B4)](https://pkg.go.dev/mod/github.com/myron-meng/sqlboiler/v4)
...
| ----------------- | --------------- |
| PostgreSQL        | [https://github.com/myron-meng/sqlboiler/v4/drivers/sqlboiler-psql](drivers/sqlboiler-psql)
| MySQL             | [https://github.com/myron-meng/sqlboiler/v4/drivers/sqlboiler-mysql](drivers/sqlboiler-mysql)
| MSSQLServer 2012+ | [https://github.com/myron-meng/sqlboiler/v4/drivers/sqlboiler-mssql](drivers/sqlboiler-mssql)
| SQLite3           | [https://github.com/myron-meng/sqlboiler/v4/drivers/sqlboiler-sqlite3](drivers/sqlboiler-sqlite3)
...
```shell
# Go 1.16 and above:
go install github.com/myron-meng/sqlboiler/v4@latest
go install github.com/myron-meng/sqlboiler/v4/drivers/sqlboiler-psql@latest
...
GO111MODULE=on go get -u -t github.com/myron-meng/sqlboiler/v4
GO111MODULE=on go get github.com/myron-meng/sqlboiler/v4/drivers/sqlboiler-psql
```
...
import . "github.com/myron-meng/sqlboiler/v4/queries/qm"
...
For a comprehensive ruleset for `Bind()` you can refer to our [pkg.go.dev](https://pkg.go.dev/github.com/myron-meng/sqlboiler/v4/queries#Bind).
...
by using the
[boil.BeginTx()](https://pkg.go.dev/github.com/myron-meng/sqlboiler/v4/boil#BeginTx)
...
[boil.Columns.InsertColumnSet](https://pkg.go.dev/github.com/myron-meng/sqlboiler/v4/boil/#Columns.InsertColumnSet)
for more details.
...
See the documentation for
[boil.Columns.UpdateColumnSet](https://pkg.go.dev/github.com/myron-meng/sqlboiler/v4/boil/#Columns.UpdateColumnSet)
for more details.
